...
const title = {
	name: 'PUT THE HEALTH BACK INTO WHS WITH KEEN SAFETY',
	subtitle: `Once you're a member of Keen Safety you will be able to:`
}

const options = [
	{ title: 'SEND AND RECEIVE NOTIFICATIONS OF WHS ISSUES', description: 'Send notifications from your phone receive them instantly on the website in the office', icon: 1 },
...
const Health = () => <div className="clearfix">
	<div className="content-section commercial-health">
	...
	<div className="content-section bgwhite how-it-work-info">
		...
		<img src="../assets/images/commercial-health.jpg" alt="Smiley face" />
